...
# this is a pydantic class -> a class to hold some data, can be easily turned to json, it describes a json schema. you can also turn a json back into this item pydantic object.
class Item(BaseModel):
    ...
    category: str
    price: float
    full: Optional[str] = None  # full desc from amazon
    weight: Optional[float] = None
    summary: Optional[str] = None  # summarised desc
