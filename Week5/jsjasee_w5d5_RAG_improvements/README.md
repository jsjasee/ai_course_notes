...
- Rule-based structured question answering for exact salary counts and tenure averages
- Fully automated evaluation additions for the new structured-question path

The PRD for this upgrade is in [`PRD.md`]
